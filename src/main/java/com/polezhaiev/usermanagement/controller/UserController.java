...
public class UserController {
    ...
    @Operation(summary = "Update user's phone number", description = "Update user's phone number")
    @PutMapping("/phone/{id}")
    ...
    @Operation(summary = "Delete the user by id", description = "Delete the user by id")
    @DeleteMapping("/{id}")
    public boolean deleteById(@PathVariable Long id) {
        return userService.deleteById(id);
    }

    @Operation(summary = "Search users by birthdate range", description = "Search users by birthdate range")
    @GetMapping
